...
{
    internal class AS_CARPLACES_PARAMS : IDisposable
    {
        public const string SQL_TABLE_NAME = "AS_CARPLACES_PARAMS";
        public const string SQL_TABLE_TEMP_NAME = "AS_CARPLACES_PARAMS_Temp";
        ...
        public AS_CARPLACES_PARAMS(SqlConnection sqlConnection, string filesDirectory, string xmlFileName, bool useMerge)
        {
